...
const LoginPage = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect based on email (in a real app, this would be based on the user role)
        ...
        >
          <form className="space-y-6" onSubmit={handleLogin}>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <a href="#" className="font-medium text-hostel-primary hover:text-hostel-secondary">
          ...
          <div className="mt-6 text-center text-sm">
            <p className="text-gray-600">
              ...
              <Link to="/signup" className="font-medium text-hostel-primary hover:text-hostel-secondary">
                Sign up now
              </Link>
            </p>
          </div>
